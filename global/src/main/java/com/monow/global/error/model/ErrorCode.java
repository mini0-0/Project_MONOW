...
public enum ErrorCode {
    ...
    HOLDING_NOT_FOUND(HttpStatus.NOT_FOUND, "HOLDING_NOT_FOUND", "보유 종목을 찾을 수 없습니다."),
    TRANSACTION_HISTORY_NOT_FOUND(HttpStatus.NOT_FOUND, "TRANSACTION_HISTORY_NOT_FOUND", "거래 내역을 찾을 수 없습니다."),
